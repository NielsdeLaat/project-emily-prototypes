              ...
              selectedStory ? (
                ...
                <div className="story-card">
                  ...
                  <p className="text-sm italic mb-4 flex items-center gap-1" style={{ color: '#777' }}>
                    ...
                    {selectedStory.title === 'Emily'
                      ? 'Hong Kong'
                      : `${placeTranslations[selectedStory.location.name] || selectedStory.location.name}, ${placeTranslations[selectedStory.location.country] || selectedStory.location.country}`
                    }
                  </p>
                  ...
                  >
                    Leer meer over {selectedStory.title}
                  </button>
